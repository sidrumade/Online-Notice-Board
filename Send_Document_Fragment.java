...
public class Send_Document_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fregment_send_document,container,false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        choosebutton=(Button)view.findViewById(R.id.chooseDocbutton);
        uploadbutton=(Button) view.findViewById(R.id.uploadDocbutton);
        showchossed=(TextView)view.findViewById(R.id.showchossedDoc);
        mydatabase=FirebaseDatabase.getInstance().getReference("Data");
        progressbar = (ProgressBar) view.findViewById(R.id.Docprogressbar);
        dis=(EditText)view.findViewById(R.id.Docdiscrip);
    ...
    private void uploadFile(final Uri filepath)
    {
        ...
        storage.child("UploadedDocuments").child(filename).putFile(filepath).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
                    ...
                    if (taskSnapshot.getMetadata().getReference() != null) {
                        ...
                        result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void insertLinkToDB()
                            {
                                ...
                                dis.setText("");
                                mydatabase.child("Documents").child(id).setValue(n).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
